...
NAV2D.Navigator = function(options) {
  ...
  if (withOrientation === false){
	...
	document.getElementById("loc_x_").value=""+pose.position.x;
	document.getElementById("loc_y_").value=""+pose.position.y;
	
	//document.getElementById("MouseY").innerText =""+pose.orientation;
        // send the goal
        // sendGoal(pose);
      }
    };
